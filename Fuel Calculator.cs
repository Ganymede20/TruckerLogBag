...
namespace Trucker_Log_Bag
{
    public partial class Fuel_Calculator : Form
    {
        ...
        {
            belgium++;
            belgiumprice = belgiumprice + 1.27;
        ...
        {
            denmark++;
            denmarkprice = denmarkprice + 1.27;
        ...
        {
            england++;
            englandprice = englandprice + 1.35;
        ...
        {
            germany++;
            germanyprice = germanyprice + 1.14;
        ...
        {
            hungary++;
            hungaryprice = hungaryprice + 1.13;
        ...
        {
            luxembourg++;
            luxembourgprice = luxembourgprice + 1.00;
        ...
        {
            netherlands++;
            netherlandsprice = netherlandsprice + 1.22;
        ...
        {
            slovakia++;
            slovakiaprice = slovakiaprice + 1.09;
        ...
        {
            switzerland++;
            switzerlandprice = switzerlandprice + 1.33;
